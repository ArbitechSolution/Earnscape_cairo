...
use crate::utils::{
    ...
    ONE_BILLION_TOKENS, setup_earn_token, get_balance
};
...
fn test_transfer_from() {
    ...
    assert(
        token.balance_of(OWNER()) == ONE_BILLION_TOKENS - transfer_amount, 
        'Wrong owner balance'
    );
    ...
    assert(
        remaining_allowance == approve_amount - transfer_amount, 
